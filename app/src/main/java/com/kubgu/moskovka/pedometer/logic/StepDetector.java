...
public class StepDetector {
    ...
    private static final float MAX_STEP_THRESHOLD = 50f;
    ...
    public StepDetector(double sensitivity)
    {
    ...
    public void updateAccel(long timeNs, float x, float y, float z) {
        ...
        if (velocityEstimate > (1 - sensitivity) * MAX_STEP_THRESHOLD
                && oldVelocityEstimate <= (1 - sensitivity) * MAX_STEP_THRESHOLD
